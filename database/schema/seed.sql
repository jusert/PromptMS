...
(2, '中转英', 1, '中文草稿润色为英文 LaTeX 代码片段', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, '英转中', 1, '英文 LaTeX 代码片段翻译为通俗中文', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, '中转中', 1, '中文草稿润色为中文论文风格', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, '英缩写', 1, '缩写英文 LaTeX 代码片段', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, '英扩写', 1, '扩写英文 LaTeX 代码片段', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

(2, '表达润色（英文论文）', 1, '对英文 LaTeX 代码片段进行深度润色与重写', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, '表达润色（中文论文）', 1, '对中文论文段落进行专业审视与润色', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, '逻辑检查', 1, '对英文 LaTeX 代码片段进行最后的一致性与逻辑核对', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, '去 AI 味', 1, '对英文 LaTeX 代码片段进行“去 AI 化”重写',CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2,'论文架构图', 1, '提供的论文方法描述，绘制论文架构图', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

(2,'实验绘图推荐', 1, '针对实验结果绘图（主要从LLM方向论文考虑），给出图表类型推荐', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2,'生成图的标题', 1, '撰写精准、规范的论文插图标题', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2,'生成表的标题', 1, '撰写精准、规范的论文表格标题', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2,'实验分析', 1, '撰写高质量的学术分析报告', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2,'论文整体以 Reviewer 视角进行审视', 1, '论文整体以 Reviewer 视角进行审视', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
# Input
{{在此处粘贴你的中文草稿}}', 1, CURRENT_TIMESTAMP),
...
# Input
{{在此处粘贴你的英文 LaTeX 代码}}', 1, CURRENT_TIMESTAMP),
...
# Input
{{在此处粘贴你的中文草稿、零散的想法或要点}}', 1, CURRENT_TIMESTAMP),
...
# Input
{{在此处粘贴你的中文论文段落}}',1, CURRENT_TIMESTAMP),
(8,'# Role
...
Underscore, Unveil, Vibrant',1, CURRENT_TIMESTAMP),
(10,'"""You are an expert Scientific Illustrator for top-tier AI conferences (NeurIPS/CVPR/ICML).
...
Highlight the core novelty. Ensure the connection logic makes sense."""',1, CURRENT_TIMESTAMP),
(11,'# Role
...
# Input
{{在此处粘贴你的实验数据（推荐直接复制 Excel/CSV 原始表格，保持行列结构），并请简述你想通过这张图强调的核心结论}}',1, CURRENT_TIMESTAMP),
(12,'# Role
...
# Input
{{在此处粘贴你的中文描述}}',1, CURRENT_TIMESTAMP),
(13,'# Role
...
# Input
{{在此处粘贴你的 Excel 数据或实验结果文本}}',1, CURRENT_TIMESTAMP),
(15,'# Role
...
# Input
请根据我上传的pdf附件进行分析，我计划投稿于 {{在此处输入你的投稿目标，例如：ICML 2026}}',1, CURRENT_TIMESTAMP);